<template>
  <nav
    ...
    :class="{ 'is-transparent transparent-bg': isHome }"
  >
    ...
    >
      ...
      <div class="navbar-end">
        ...
        <a
          class="navbar-item github-button"
          href="https://github.com/nedpals/mangavue"
          data-size="large"
          data-show-count="true"
          aria-label="Star nedpals/mangavue on GitHub"
        >Star</a>
        <a
